  ...
  return (
    <div className='md:px-18 flex flex-row gap-8 px-12 py-32 text-left lg:px-24'>
      ...
      <div className='relative w-full justify-center'>
        <span className='absolute left-[-7%] top-[-5%] flex flex-col rounded-xl bg-white text-5xl font-bold text-red-600'>
          {blok.years}+<span className='text-3xl text-black'>Years</span>
        </span>
        <Image
